  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Header */}
        <header
          className="flex items-end justify-between px-5 pb-3 pt-3 flex-shrink-0"
      ...
      {/* Info button (reopens instructions) + Rate button — testing UI, not part
          of the docked interface, so it lives in the outer full-screen container. */}
